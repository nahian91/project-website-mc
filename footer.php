        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="single-footer contact">
                    <h4>get in touch</h4>
                    <ul>
                        <li><i class="fas fa-map-marker-alt"></i> manikpir road, sylhet</li>
                        <li><i class="far fa-envelope"></i> info@website.com</li>
                        <li><i class="fas fa-phone-alt"></i> +880 123 4567 890</li>
                        <li><i class="fas fa-mobile-alt"></i> +880 123 4567 890</li>
                        <li><i class="fas fa-globe-europe"></i> www.website.com</li>
                    </ul>
                </div>
            </div>
        </div>
